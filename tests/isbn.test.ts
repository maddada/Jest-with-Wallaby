...
// alternately by 1 or 3(i.e., 1 x 1st digit, 3 x 2nd digit, 1 x 3rd digit, 3 x 4th digit, etc.),
// summing these products together, taking modulo 10 of the result and subtracting this value from 10,
...
import checkIsbn from '../src/isbn';

describe('checkIsbn(string)', () => {
  it(`when it recieves a negative integer it should throw an error'`, () => {
    expect(checkIsbn('0471958697')).toEqual(true);
  });
});
